        ...
        <div class="col-lg-4">
            <div class="card shadow">
                <div class="card-header">
                    <h2 class="fw-bold text-seondary">Register</h2>
                </div>
                <div class="card-body p-5">
                    <div id="show_success_alert"></div>
                    <form action="post" action="#" id="register-form">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-grid">
                            <input type="submit" value="Register" class="btn- btn-dark rounder-0" id="register-btn">
                        </div>
                        <div class="text-center text-secondary">
                            <div>
                                Already have an account? <a class="text-decoration-none" href="/login"> Login here</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    if(res.status==400){
                        ...
                        removeValidClasses("#register-form");
                        $("#register-btn").val('Registered');
                    }
